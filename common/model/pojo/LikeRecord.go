...
type LikeRecord struct {
	...
	TargetID   int64     `gorm:"type:bigint;not null;uniqueIndex:idx_user_biz;comment:被点赞业务ID(视频/文章/评论)"`
	TargetType string    `gorm:"type:varchar(32);not null;uniqueIndex:idx_user_biz;comment:业务类型(video/article/comment)"`
